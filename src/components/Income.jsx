      ...
      <div className="relative flex h-auto min-h-screen w-full flex-col group/design-root overflow-x-hidden">
        ...
        <div className="flex px-4 py-3">
          <div className="flex h-10 flex-1 items-center justify-center rounded-lg bg-[#f0f2f4] dark:bg-gray-800 p-1">
            ...
            <label className="flex cursor-pointer h-full grow items-center justify-center overflow-hidden rounded-lg px-2 has-[:checked]:bg-[#22c55e] has-[:checked]:text-white has-[:checked]:shadow-[0_0_4px_rgba(34,197,94,0.5)] text-[#617589] dark:text-gray-400 text-sm font-medium leading-normal transition-colors" onClick={() => navigate('/income') }>
              ...
              {/* Corrected the checked attribute */}
              <input
                defaultChecked
                className="invisible w-0"
                name="transaction_type"
        ...
        <div className="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3">
          <label className="flex flex-col min-w-40 flex-1">
            ...
            <div className="relative">
              <span className="absolute inset-y-0 left-0 flex items-center pl-4 text-[#22c55e] peer-focus:text-[#22c55e]">
                ₹
              </span>
              <input
                className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-[#22c55e] focus:outline-0 focus:ring-0 border-none bg-[#f0f2f4] dark:bg-gray-800 focus:border-none h-14 placeholder:text-[#617589] dark:placeholder-gray-400 p-4 pl-8 text-2xl font-bold leading-normal peer"
                placeholder="0.00"
                value={amount}
        ...
        <div className="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3">
          ...
          >
            ...
            <select className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-[#111418] dark:text-white focus:outline-0 focus:ring-0 border-none bg-[#f0f2f4] dark:bg-gray-800 focus:border-none h-14 bg-[image:--select-button-svg] placeholder:text-[#617589] dark:placeholder-gray-400 p-4 text-base font-normal leading-normal appearance-none" onChange={(e) => setCategory(e.target.value)}>
        ...
        <div className="px-4 py-5 bg-background-light dark:bg-background-dark sticky bottom-0">
          <button className="flex w-full cursor-pointer items-center justify-center overflow-hidden rounded-lg h-14 bg-[#22c55e] text-white gap-2 text-base font-bold leading-normal tracking-[0.015em] min-w-0 px-4" onClick={saveIncome}>
            Save Income
          </button>
        </div>
      </div>
